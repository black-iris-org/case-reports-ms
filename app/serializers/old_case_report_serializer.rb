class OldCaseReportSerializer < ApplicationSerializer
  identifier :id
  ...
  view :without_health_data do
    association :revisions, view: :without_health_data, blueprint: RevisionSerializer
    association :revision, view: :without_health_data, blueprint: RevisionSerializer
  end
